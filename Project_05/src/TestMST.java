...
public class TestMST {
	...
	public static void main(String[] args){
		try{
			...
			Graph instanceOfGraph = new Graph(vertexCount, vertexList, distanceMatrix, true);
			...
			//System.out.println(instanceOfGraph);
			//instanceOfGraph.printAdjancecyMatrix();
			
			//TreeSet<Edge> m = mst.Kruskal(instanceOfGraph);
			//mst.Kruskal(instanceOfGraph);
			//System.out.println(m.toString());
				
			//mst.Prim(instanceOfGraph, sourceVertex);
			//mst.mapPrint(instanceOfGraph);
